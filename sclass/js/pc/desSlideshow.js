...
(function(a){
    a.fn.desSlideshow=function(p){
        ...
        var directory=p&&p.directory?p.directory:"image/main";
        ...
        if(autoplay == "enable"){
            ...
            g.find(".nav").css("background-color","#fff");
        ...
        function init(){
            g.css("width",slideshow_width+"px").css("height",slideshow_height+"px").css("position","relative").css("overflow","hidden"); //.css("border-top","1px solid #CCCCCC") .css("font-family","Verdana,Geneva,sans-serif")
            g.find("a").css("color","#fff");
            g.find("img").css("border","none");
            g.find("ul").css("margin","0px").css("padding","0px");
            g.find("li").css("padding","0px").css("list-style","none"); //.css("margin-top","1px")
            g.find(".switchBigPic").css("position","relative");
            g.find(".switchBigPic").children("div").css("position","absolute").css("left","300px").css("overflow","hidden");
            ...
            g.find(".nav").children("li").css("height","55px").css("background-image","url("+directory+"flashtext-bg.jpg)").css("line-height","55px"); //.css("border-bottom","1px solid #CCCCCC") .css("border-right","1px solid #CCCCCC")
            g.find(".nav").children("li").children("a").css("text-decoration","none").css("height","55px").css("display","block").css("padding-left","25px").css("font-size","14px");
            g.find(".nav").children("li").css("margin-left","0px");
            g.find(".switchBigPic").children("div").hide();
        }
        function showpic(){
            clearTimeout(v);
            g.find(".nav").children("li").css("background-image","url("+directory+"flashtext-bg.jpg)").css("border-bottom","1px solid #fff").css("background-color","#949494");
            g.find(".nav").children("li").eq(current).css("background-image","url("+directory+"flash-on.gif)").css("border-bottom","1px solid #CCCCCC").css("background-color","#3D291A");
